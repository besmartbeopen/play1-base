...
public class QProvince extends EntityPathBase<Province> {
    ...
    public final SetPath<models.geo.Municipal, QMunicipal> municipals = this.<models.geo.Municipal, QMunicipal>createSet("municipals", models.geo.Municipal.class, QMunicipal.class, PathInits.DIRECT2);
