...
public class QRevision extends EntityPathBase<Revision> {
    ...
    public final models.common.query.QOperator owner;
    ...
    public QRevision(Class<? extends Revision> type, PathMetadata metadata, PathInits inits) {
        ...
        this.owner = inits.isInitialized("owner") ? new models.common.query.QOperator(forProperty("owner"), inits.get("owner")) : null;
    }
