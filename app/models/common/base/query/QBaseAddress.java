...
import models.common.base.BaseAddress;
...
public class QBaseAddress extends EntityPathBase<BaseAddress> {
    ...
    public final models.common.geo.query.QMunicipal municipal;
    ...
    public QBaseAddress(Class<? extends BaseAddress> type, PathMetadata metadata, PathInits inits) {
        ...
        this.municipal = inits.isInitialized("municipal") ? new models.common.geo.query.QMunicipal(forProperty("municipal"), inits.get("municipal")) : null;
    }
